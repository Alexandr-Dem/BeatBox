...
public class ButtonUI extends BasicToggleButtonUI {
    ...
    public static Color buttonBg = new Color (0, 25, 255, 184); //при нажатии

    private AbstractButton button;

    private Color topBg = new Color (254, 253, 255, 170);
    ...
    private Color staticTopBg = new Color (189, 172, 240, 66); //верх кнопки
    private Color disabledStaticTopBg = new Color (238, 234, 236);
    private Color staticBottomBg = new Color (131, 125, 157, 181);//низ кнопки
    private Color disabledStaticBottomBg = new Color ( 245, 245, 245 );

    private Color staticBorderColor = new Color (4, 0, 230 );
    ...
    public ButtonUI(final AbstractButton button )
    {
        this ( button, true, defaultMouseoverTransparency );
    }

    public ButtonUI(final AbstractButton button, final boolean changeForeground )
    {
        this ( button, changeForeground, defaultMouseoverTransparency );
    }

    public ButtonUI(final AbstractButton button, float mouseoverTransparency )
    {
...
//    }
    ...
    public static ButtonUI setupButtonUI (AbstractButton button )
    {
        return setupButtonUI ( button, -1 );
    }

    public static ButtonUI setupButtonUI (AbstractButton button, Insets insets )
    {
        return setupButtonUI ( button, -1, insets );
    }

    public static ButtonUI setupButtonUI (AbstractButton button, int rounded )
    {
        return setupButtonUI ( button, Arrays.asList ( rounded ) );
    }

    public static ButtonUI setupButtonUI (AbstractButton button, int rounded, Insets insets )
    {
    ...
    public static ButtonUI setupButtonUI (AbstractButton button, java.util.List<Integer> rounded,
                                          Insets insets )
    {
        ButtonUI stbui = new ButtonUI( button, false );
    ...
    public static ButtonUI setupDialogButtonUI (AbstractButton button, int rounded )
    {
        return setupDialogButtonUI ( button, Arrays.asList ( rounded ) );
    }

    public static ButtonUI setupDialogButtonUI (AbstractButton button,
                                                java.util.List<Integer> rounded )
    {
    ...
    {
        ButtonUI gbui = setupButtonUI ( button, rounded, insets );
        gbui.setStaticBorderColor ( new Color ( 155, 155, 155 ), new Color ( 175, 175, 175 ) );
        gbui.setStaticColor ( new Color ( 132, 132, 132 ), new Color ( 175, 175, 175 ) );
